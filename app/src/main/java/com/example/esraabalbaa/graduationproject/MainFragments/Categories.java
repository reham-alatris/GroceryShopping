...
public class Categories extends Fragment {
    ...
    private void prepareProducts() {
        ...
        product a = new product("cow milk 100mm", 13, covers[0]);
        productList.add(a);

        a = new product("cow milk 100mm", 13, covers[1]);
        productList.add(a);

        a = new product("cow milk 100mm", 13, covers[2]);
        productList.add(a);

        a = new product("cow milk 100mm", 13, covers[3]);
        productList.add(a);

        a = new product("cow milk 100mm", 13, covers[4]);
        productList.add(a);

        a = new product("cow milk 100mm", 13, covers[5]);
        productList.add(a);
